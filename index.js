...
function reverseCharacters (myVariableName){
  let reversedVariable = [];
  let reversedString = "";
  reversedVariable = myVariableName.split(", ").reverse();
  reversedString = reversedVariable.join();
  return reversedString;
}
let myVariableName = "car, house, truck, job, family, folks";
...
function reverseCharactersOrNumbers (myVariableNameOrNumber){
  let reversedVariableNameOrNumber = [];
  let reversedStringOrNumber = "";
  if (typeof myVariableNameOrNumber === 'string'){
  reversedVariableNameOrNumber = myVariableNameOrNumber.split("").reverse();
  reversedStringOrNumber = reversedVariableNameOrNumber.join("");
  }
  else{  
   myVariableNameOrNumber = myVariableNameOrNumber.toString();
    let myNumberString = myVariableNameOrNumber.toString();
    reversedVariableNameOrNumber = myNumberString.split("").reverse();
    reversedStringOrNumber = reversedVariableNameOrNumber.join("");
  }
  return reversedStringOrNumber;
}
let myVariableNameOrNumber = 4321922;


console.log(reverseCharactersOrNumbers(myVariableNameOrNumber));
